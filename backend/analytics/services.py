...
from questions.models import UserAnswer, QuestionType, CategoryAnalytics
...
EMPLOYEE_CATEGORIES: list[CategoryAnalytics] = [
...
def average_employee_points_by_categories(
    employee: Employee,
    categories: list[CategoryAnalytics] = None,
    curator_answers: bool = False,
...
def average_project_points_by_categories(
    ...
    for category in categories:
        ...
        project_stats.append(
            {"category": category, "category_display": category.label, "value": average}
        )
