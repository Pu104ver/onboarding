...
from questions.models import PollStatus, PollQuestion, UserType, CategoryAnalytics
...
def project_deleted(sender, instance: Project, **kwargs):
    """
    При удалении проекта - удаляет все шаблоны и запланированные опросы (CASCADE) по этому проекту
    """
...
def create_pollquestion_for_project(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        list_questions = [
            ...
            (
                "Отлично, хорошего тебе рабочего дня - вечером я еще вернусь узнать, как твои дела",
                "finish",
            ),
        ...
        list_questions = [
            (
                "Сегодня завершился твой первый рабочий день. Как все прошло? Все ли было хорошо?",
                "yes_no",
            ),
        ...
        list_questions = [
            ...
            ("Спасибо!", "next"),
            (
                "Как ты себя чувствуешь на проекте?",
                "numbers",
                CategoryAnalytics.GENERAL_HEALTH,
            ),
            ("Можешь объяснить, что именно повлияло на твою оценку?", "message"),
            ("Спасибо за обратную связь!", "finish"),
        ]
        ...
        list_questions = [
            (
                ...
                "numbers",
                CategoryAnalytics.RESPONSIBILITIES,
            ),
            ("Можешь объяснить, что именно повлияло на твою оценку?", "message"),
            ("Спасибо!", "next"),
            (
                "Как ты оцениваешь своё понимание задач и сроков их выполнения по шкале от 1 до 5?",
                "numbers",
                CategoryAnalytics.UNDERSTAND_TASKS_DEADLINES,
            ),
            ("Можешь объяснить, что именно повлияло на твою оценку?", "message"),
            ("Спасибо!", "next"),
            (
                "Насколько твои ожидания соответствуют реальности? Оцени, пожалуйста, от 1 до 5.",
                "numbers",
                CategoryAnalytics.JOB_EXPECTATIONS,
            ),
            ("Можешь объяснить, что именно повлияло на твою оценку?", "message"),
            ("Спасибо!", "next"),
            (
                ...
                "numbers",
                CategoryAnalytics.TEAM_SATISFACTIONS,
            ),
            ("Можешь объяснить, что именно повлияло на твою оценку?", "message"),
            ("Спасибо!", "next"),
            (
            ...
            (
                "Какие изменения, на твой взгляд, могли бы помочь улучшить работу?",
                "message",
            ),
            ("Спасибо за обратную связь!", "finish"),
        ]
        ...
        list_questions = [
            ...
            (
                "Можешь объяснить, что именно повлияло на твою оценку?",
                "message",
            ),
            ("Спасибо!", "next"),
            (
            ...
            ("Спасибо за обратную связь!", "finish"),
            (
                "Сейчас с тобой свяжется менеджер и расскажет, когда будет встреча",
                "finish",
            ),
        ]
        ...
        list_questions = [
            (
                "Удалось ли настроить рабочее место и необходимые доступы сотруднику?",
                "yes_no",
            ),
            ("Напишите, какие доступы необходимо настроить", "message"),
            ("Спасибо! Информацию передали менеджеру!", "next"),
            (
                "Насколько Вы удовлетворены тем, как втягивается в работу сотрудник?",
                "numbers",
                CategoryAnalytics.INVOLVEMENT,
            ),
            ("Почему вы дали такой ответ на этот вопрос?", "message"),
            ("Спасибо! Информацию передали менеджеру", "next"),
            (
                "Сотрудник вовремя выходит на связь? 1-не выходит на связь, 5-выходит регулярно",
                "numbers",
                CategoryAnalytics.ANSWER_SPEED,
            ),
            (
                "Сотрудник присутствует на встречах? 1-не присутствует, 5-присутствует регулярно",
                "numbers",
                CategoryAnalytics.PRESENCE_MEETING,
            ),
            ("Спасибо за обратную связь!", "finish"),
        ]
        ...
        list_conditions = [
            ...
            (questions[7], questions[6], "2"),
            (questions[7], questions[6], "3"),
            (questions[7], questions[6], "4"),
            (questions[7], questions[6], "5"),
            (questions[8], questions[7], "1"),
            (questions[8], questions[7], "2"),
            (questions[8], questions[7], "3"),
            (questions[8], questions[7], "4"),
            (questions[8], questions[7], "5"),
        ]
        ...
        list_questions = [
            (
                "Оцените, насколько вы удовлетворены качеством выполнения сотрудником своих задач?",
                "numbers",
                CategoryAnalytics.QUALITY_TASKS,
            ),
            ("Почему вы дали такой ответ на этот вопрос?", "message"),
            ("Спасибо! Информацию передали менеджеру", "next"),
            (
                "Оцените, насколько вы удовлетворены уровнем дисциплины сотрудника",
                "numbers",
                CategoryAnalytics.DISCIPLINE,
            ),
            ("Почему вы дали такой ответ на этот вопрос?", "message"),
            ("Спасибо! Информацию передали менеджеру", "next"),
            (
                ...
                "numbers",
                CategoryAnalytics.QUALITY_INTERACTIONS,
            ),
            ("Почему вы дали такой ответ на этот вопрос?", "message"),
            ("Спасибо! Информацию передали менеджеру", "next"),
            (
                "Напишите, пожалуйста, какие у вас имеются пожелания к сотруднику и компании?",
                "message",
            ),
        ...
        list_conditions = [
            ...
            (questions[8], questions[7], "some_text"),
            (questions[9], questions[8], "next"),
            (questions[10], questions[9], "some_text"),
            (questions[11], questions[10], "no"),
            (questions[12], questions[11], "some_text"),
            (questions[12], questions[10], "yes"),
            (questions[13], questions[12], "1"),
            (questions[13], questions[12], "2"),
            (questions[13], questions[12], "3"),
            (questions[13], questions[12], "4"),
            (questions[13], questions[12], "5"),
            (questions[14], questions[13], "1"),
            (questions[14], questions[13], "2"),
            (questions[14], questions[13], "3"),
            (questions[14], questions[13], "4"),
            (questions[14], questions[13], "5"),
            (questions[15], questions[14], "no"),
            (questions[16], questions[15], "some_text"),
            (questions[16], questions[14], "yes"),
        ]
        ...
        poll_11 = PollQuestion.objects.create(
            title="2-й месяц",
            message="Здравствуйте! Сегодня два месяца, как с Вами работает {}. Ответьте, пожалуйста, на несколько вопросов",
            days_after_hire=60,
            time_of_day="morning",
            intended_for=UserType.CURATOR,
            content_type=project_content_type,
        ...
        list_questions = [
            ...
            ("Спасибо! Информацию передали менеджеру", "next"),
            ("Оставляем сотрудника?", "yes_no"),
            ("Что послужило причиной такого решения?", "message"),
            ("Спасибо! Информацию передали менеджеру", "next"),
            (
                "Напишите, пожалуйста, какие у вас имеются пожелания к сотруднику и компании?",
                "message",
        ...
        list_conditions = [
            ...
            (questions[11], questions[10], "some_text"),
            (questions[12], questions[9], "yes"),
            (questions[12], questions[11], "next"),
            (questions[13], questions[12], "some_text"),
            (questions[14], questions[13], "no"),
            (questions[15], questions[13], "yes"),
            (questions[15], questions[14], "some_text"),
            (questions[16], questions[15], "1"),
            (questions[16], questions[15], "2"),
            (questions[16], questions[15], "3"),
            (questions[16], questions[15], "4"),
            (questions[16], questions[15], "5"),
            (questions[17], questions[16], "1"),
            (questions[17], questions[16], "2"),
            (questions[17], questions[16], "3"),
            (questions[17], questions[16], "4"),
            (questions[17], questions[16], "5"),
        ]
