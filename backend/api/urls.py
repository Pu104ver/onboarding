...
from api.auth.token import CustomAuthToken, KeycloakAuthTokenView, RefreshTokenView, keycloak_callback_signout
...
from api.views.users import CustomUserViewSet, AuthenticationApplicationCreateAPIView
...
router.register(r"auth-app", AuthenticationApplicationCreateAPIView, basename="auth-app")
...
urlpatterns = [
    ...
    path("auth/token/", KeycloakAuthTokenView.as_view(), name="keycloak_token"),
    path("auth/token/refresh/", RefreshTokenView.as_view(), name="keycloak_token_refresh"),
    path('keycloak_callback_signout/', keycloak_callback_signout, name='keycloak_callback_signout'),
    path(
