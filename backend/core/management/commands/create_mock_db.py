            ...
            with transaction.atomic():
                ...
                list_questions = [
                    (
                        ...
                        "numbers", CategoryAnalytics.INTEREST_PROJECT),
                    ...
                    ("Как ты оцениваешь качество обратной связи от руководителя? Поставь оценку от 1 до 5.", "numbers",
                     CategoryAnalytics.QUALITY_FEEDBACK),
                    ("Подскажи, пожалуйста, почему ты поставил такую оценку?", "message"),
                    ("Спасибо!", "next"),
                    ("Насколько совпадают задачи с твоими ожиданиями? Оцени от 1 до 5.", "numbers",
                     CategoryAnalytics.PROJECT_EXPECTATIONS),
                    ("Подскажи, пожалуйста, почему ты поставил такую оценку?", "message",),
                    ("Спасибо!", "next"),
                    ...
                    ("Спасибо!", "next"),
                    ("Как ты себя чувствуешь на проекте?", "numbers", CategoryAnalytics.GENERAL_HEALTH),
                    ("Подскажи, пожалуйста, почему ты поставил такую оценку?", "message"),
                    ("Спасибо!", "next"),
                ...
                list_questions = [
                    ...
                    ("Почему вы дали такой ответ на этот вопрос?", "message"),
                    ("Спасибо! Информацию передали менеджеру", "next"),
                    ("Напишите, пожалуйста, какие у вас имеются пожелания к сотруднику и компании?", "message"),
                    ("Сотрудник вовремя выходит на связь? 1-не выходит на связь, 5-выходит регулярно", "numbers",
                     CategoryAnalytics.ANSWER_SPEED),
                    ("Сотрудник присутствует на встречах? 1-не присутствует, 5-присутствует регулярно", "numbers",
                ...
                list_conditions = [
                    ...
                    (questions[11], questions[10], "4"),
                    (questions[11], questions[10], "5"),
                    (questions[12], questions[11], "1"),
                    (questions[12], questions[11], "2"),
                    (questions[12], questions[11], "3"),
                    (questions[12], questions[11], "4"),
                    (questions[12], questions[11], "5"),
                ]
                ...
                for instance in projects:
                    ...
                    list_questions = [
                        ...
                        "numbers", CategoryAnalytics.ONBOARDING_SATISFACTIONS),
                ...
                list_questions = [
                    ...
                    ("Есть ли вопросы/комментарии по твоей работе?", "yes_no"),
                ...
                list_conditions = [
                    ...
                    (questions[4], questions[3], "yes"),
                    (questions[4], questions[3], "no"),
                    (questions[5], questions[4], "yes"),
                    (questions[6], questions[4], "no"),
                ...
                list_questions = [
                    ...
                    ("Есть ли вопросы/комментарии по работе сотрудника?", "yes_no"),
